    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Loading Interview Portal</h3>
          <p className="text-gray-600 dark:text-gray-400">Preparing your interview session...</p>
        </div>
      </div>
    )
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Oddiant Interview Portal</h1>
                <p className="text-gray-600 dark:text-gray-400">Professional Interview Platform</p>
              </div>
            </div>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          ...
                          {interview.candidate?.phone && (
                            <p className="text-sm text-gray-600 dark:text-gray-400">{interview.candidate.phone}</p>
                          )}
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900 dark:text-white">{formatDate(interview.date)}</p>
                      ...
                      <div className="flex items-center space-x-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900 dark:text-white">{formatTime(interview.time)}</p>
                          <p className="text-sm text-gray-600 dark:text-gray-400">
                ...
                {interview.companyName && (
                  <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 border border-blue-200 dark:border-blue-800 mb-8">
                    ...
                    <div className="flex items-center space-x-4">
                      ...
                      <div>
                        <p className="font-semibold text-gray-900 dark:text-white text-lg">{interview.companyName}</p>
                        {interview.location && (
                          <div className="flex items-center mt-1">
                            <MapPin className="h-4 w-4 mr-1 text-gray-600 dark:text-gray-400" />
                            <span className="text-sm text-gray-600 dark:text-gray-400">{interview.location}</span>
                          </div>
                        )}
                      </div>
                    </div>
                ...
                <div className="text-center">
                  <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-900/20 dark:to-indigo-900/20 rounded-xl p-8 border border-blue-200 dark:border-blue-800">
                    <div className="mb-6">
                      ...
                      <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-2">Ready to Join?</h3>
            ...
            <Card className="shadow-lg border border-gray-200 dark:border-gray-700">
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-800 rounded-lg">
                  ...
                  <div>
                    <span className="text-sm text-gray-900 dark:text-white font-medium">Technical Support</span>
            ...
            <Card className="shadow-lg border border-gray-200 dark:border-gray-700">
              ...
              <CardContent className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <span className="text-sm text-gray-900 dark:text-white font-medium">Join 5 minutes early</span>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Be prepared and punctual</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600 dark:text-gray-400">Ensure smooth communication</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Camera className="h-5 w-5 text-purple-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-sm text-gray-900 dark:text-white font-medium">Test camera & microphone</span>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Check audio/video quality</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <FileText className="h-5 w-5 text-orange-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-sm text-gray-900 dark:text-white font-medium">Have your resume ready</span>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Keep documents accessible</p>
                  </div>
                </div>
                <div className="flex items-start space-x-3">
                  <Monitor className="h-5 w-5 text-indigo-600 mt-0.5 flex-shrink-0" />
                  <div>
                    <span className="text-sm text-gray-900 dark:text-white font-medium">Professional environment</span>
                    <p className="text-xs text-gray-600 dark:text-gray-400">Choose a quiet, well-lit space</p>
                  </div>
                </div>
              </CardContent>
            </Card>
